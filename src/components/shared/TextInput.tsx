...
function TextInput({label, setInputValues, target, value, autoFocus=false}:TextInputProps) {
  ...
  return (
    <div className='w-1/2 text-right mx-auto my-4 self-center'>
      <div className='flex flex-row justify-center'>
        ...
        <input autoFocus={autoFocus} id={target} type={target == "resistorLoaded" ? "number" : "text" } className='basis-2/3 border-2 border-zip-dark rounded-lg p-4 self-center' value={value ?? ""}
        onKeyDown={(e) => {
